...
cd $K_SRC/out_modules/lib/modules/6.1.43
unlink source
unlink build
ln -sf /usr/src/linux-headers-6.1.43/ build
ln -sf /usr/src/linux-headers-6.1.43/ source
